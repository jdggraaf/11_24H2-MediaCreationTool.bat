...
:: - link check: wscont.apps.microsoft.com catalogs (1507 1511 1607) and the 1803 / 1809 MCT exe are gone from Microsoft -
::   replaced by Internet Archive copies of the same files; the exe still has to pass the Authenticode check
...
set "EXE=https://web.archive.org/web/20181015060756id_/https://software-download.microsoft.com/download/pr/MediaCreationTool1809.exe"
...
set "EXE=https://web.archive.org/web/20191010094141id_/https://software-download.microsoft.com/download/pr/MediaCreationTool1803.exe"
...
set "CAB=https://web.archive.org/web/20200528095636id_/https://wscont.apps.microsoft.com/winstore/OSUpgradeNotification/MediaCreationTool/prod/Products_20170116.cab"
